        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <form pjax-container action="{{ asset('admin/update-user/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <img id="output" src="{{ asset('backend/dist/img/'.$user->avatar) }}" />
                </div>
                <!-- /.card-body -->
