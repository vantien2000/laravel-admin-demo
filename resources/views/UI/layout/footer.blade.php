<footer class="footer">
    <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url({{ asset('UI/assets/images/demos/demo-4/bg-5.jpg') }});">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="{{ asset('UI/assets/images/demos/demo-4/logo-footer.png') }}" class="footer-logo" alt="Footer Logo" width="105" height="25">
