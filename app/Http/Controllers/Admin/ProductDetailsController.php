...
class ProductDetailsController extends Controller
{
    public function index(){
        ...
        return View('Admin.product_details.index')->with(['products'=>(object)$products]);
    }

    public function insert(){

        return View('Admin.products-details.create');
    }

    public function update($id){
        $product = ProductDetails::find($id);
        return View('Admin.product_details.update',['product'=>$product]);
    }
